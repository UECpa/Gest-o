    ...
    <div class="container mt-5">
        ...
        <form method="POST" enctype="multipart/form-data">
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    <label for="apolice"><i class="bi bi-file-earmark-text"></i> Apólice</label>
            ...
            <div class="form-group">
                ...
                <textarea id="observacoes" name="observacoes" class="form-control" rows="3"><?php echo htmlspecialchars($row['observacoes']); ?></textarea>
            </div>
            <div class="form-group">
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <select class="form-control" id="seguradora" name="seguradora" required>
                        <option value="Aliro Seguro" <?php if ($row['seguradora'] == 'Aliro Seguro') echo 'selected'; ?>>Aliro Seguro</option>
                        <option value="Allianz Seguros" <?php if ($row['seguradora'] == 'Allianz Seguros') echo 'selected'; ?>>Allianz Seguros</option>
                        <option value="Azul Seguros" <?php if ($row['seguradora'] == 'Azul Seguros') echo 'selected'; ?>>Azul Seguros</option>
                        <option value="HDI Seguros" <?php if ($row['seguradora'] == 'HDI Seguros') echo 'selected'; ?>>HDI Seguros</option>
                        <option value="Liberty Seguros" <?php if ($row['seguradora'] == 'Liberty Seguros') echo 'selected'; ?>>Liberty Seguros</option>
                        <option value="MAPFRE" <?php if ($row['seguradora'] == 'MAPFRE') echo 'selected'; ?>>MAPFRE</option>
                        <option value="Porto Seguro" <?php if ($row['seguradora'] == 'Porto Seguro') echo 'selected'; ?>>Porto Seguro</option>
                        <option value="Sompo Auto" <?php if ($row['seguradora'] == 'Sompo Auto') echo 'selected'; ?>>Sompo Auto</option>
                        <option value="Tokio Marine Seguros" <?php if ($row['seguradora'] == 'Tokio Marine Seguros') echo 'selected'; ?>>Tokio Marine Seguros</option>
                        <option value="Zurich Brasil Seguros" <?php if ($row['seguradora'] == 'Zurich Brasil Seguros') echo 'selected'; ?>>Zurich Brasil Seguros</option>
                        <option value="Sancor Seguros" <?php if ($row['seguradora'] == 'Sancor Seguros') echo 'selected'; ?>>Sancor Seguros</option>
                        <option value="Suhai" <?php if ($row['seguradora'] == 'Suhai') echo 'selected'; ?>>Suhai</option>
                ...
                <div class="form-group col-md-6">
                    ...
                    <select class="form-control" id="tipo_seguro" name="tipo_seguro" required>
                        ...
                        <option value="Seguro Moto" <?php if ($row['tipo_seguro'] == 'Seguro Moto') echo 'selected'; ?>>Seguro Moto</option>
                        <option value="Seguro de Vida" <?php if ($row['tipo_seguro'] == 'Seguro de Vida') echo 'selected'; ?>>Seguro de Vida</option>
                        <option value="Seguro Empresarial" <?php if ($row['tipo_seguro'] == 'Seguro Empresarial') echo 'selected'; ?>>Seguro Empresarial</option>
                        <option value="Consórcio" <?php if ($row['tipo_seguro'] == 'Consórcio') echo 'selected'; ?>>Consórcio</option>
                        <option value="Seguro Transporte" <?php if ($row['tipo_seguro'] == 'Seguro Transporte') echo 'selected'; ?>>Seguro Transporte</option>
                        <option value="Seguro Saúde" <?php if ($row['tipo_seguro'] == 'Seguro Saúde') echo 'selected'; ?>>Seguro Saúde</option>
