...
<head>
    ...
    <link rel="stylesheet" href="meses.css"> <!-- Link para o CSS separado -->
</head>
<body>
<div class="container mt-5">
    ...
    <a href="export.php?month=<?php echo $month; ?>&year=<?php echo $year; ?>" class="btn btn-info mb-3"><i class="fas fa-file-excel"></i> Exportar para Excel</a>
